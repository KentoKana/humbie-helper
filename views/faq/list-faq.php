...
<button type="button" class="jg-button-primary" data-toggle="modal" data-target="#exampleModal">
  <!-- <img id="jg-humbie-button-img"src="../../../assets/images/Humbie.png" alt="humbie the hippo"> --> Need help? 
</button>
